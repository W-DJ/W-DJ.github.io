...
<html lang="ko">
	<head>
	  ...
	  <script src="resources/script/script_Common"></script>
	...
	<div id="wrap">
	 <div id="slideshowArea">
	                ...
	                <div id="slideFrame" class="dFlex">	                
	                	...
	                	<a href="#">   <!--  -->
	                		<img src="/resources/img/Fail_Event.png" alt="슬라이드1">
	                	</a>
	                	
	                	<a href="#">
	                		<img src="/resources/img/launch-ing.png" alt="슬라이드2">
	                	</a>
	                	
	                	<a href="#">
	                		<img src="/resources/img/SampleEvent.png" alt="슬라이드3">
	                	</a>
	           ...
	           <div id="GoodsArea">
	            ...
	            <!--  상품템플릿 시작, iframe으로 변경 -->
	           <iframe src="/footer" scrolling="no" width="100%" frameborder=0 id="headerIfm"></iframe>
	        <aside>
		        <div id="sideBar">
						<ul>
